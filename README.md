...
An example of how to calculate the SSA for different initial conditions is shown in `ssa_testing.ipynb`. An example of how to calculate the quark non-singlet hPDFs is shown in `pdf_testing.ipynb`. In the latter file, I reproduce the right side of Fig. (7) from 2503.21006.
